...
public class JspCServletContext implements ServletContext {
    ...
    /**
     * Adds servlet mappings from the given url patterns to the servlet with the
     * given servlet name to this servlet context.
     */
    ...
    /**
     * Adds the filter with the given name, description, and class name to this
     * servlet context.
     */
