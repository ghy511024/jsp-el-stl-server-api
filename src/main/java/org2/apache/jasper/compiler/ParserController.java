...
import org2.apache.jasper.xmlparser.XMLEncodingDetector;
...
class ParserController implements TagConstants {
     ...
     * @param jarFile The JAR file from which to read the included resource, or
     * null of the included resource is to be read from the filesystem
     */
    ...
    /**
     * Extracts tag file directive information from the tag file with the given
     * name.
     *
     ...
     * @param directivesOnly true if the file to be parsed is a tag file and we
     * are only interested in the directives needed for constructing a
     * TagFileInfo.
    ...
    private Node.Nodes doParse(String inFileName,
        ...
        hasBom = false;
        System.out.println("我是 parsercontroller 的 doParse begin");
	...
	// Figure out what type of JSP document and encoding type we are
        ...
        if (isXml) {
            System.out.println("xml 进来，");
        } else {
              System.out.println("标准的 进来，");
            // Standard syntax
        ...
        baseDirStack.pop();
        System.out.println("我是 parsercontroller 的 doParse end");
        return parsedPage;
    }
