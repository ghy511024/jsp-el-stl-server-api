 ...
 */
package org2.apache.jasper.compiler;

import ghytest.GHYCount;
...
import org2.apache.jasper.Constants;
import org2.apache.jasper.JasperException;
import org2.apache.jasper.JspCompilationContext;
import org2.apache.jasper.runtime.JspRuntimeLibrary;
...
class Generator {
    ...
    private void generateTagHandlerInit() {
        ...
        for (String tagHandlerPoolName : tagHandlerPoolNames) {
            ...
            out.print(
                    " = org2.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(");
            if (ctxt.isTagFile()) {
                out.print("config");
            } else {
    ...
    private void genPreambleClassVariableDeclarations(String className)
        ...
        if (isPoolingEnabled) {
            if (!tagHandlerPoolNames.isEmpty()) {
                for (String tagHandlerPoolName : tagHandlerPoolNames) {
                    out.printil(
                            "private org2.apache.jasper.runtime.TagHandlerPool "
                            + tagHandlerPoolName + ";");
                }
                out.println();
            }
        ...
        out.printil("private org2.glassfish.jsp.api.ResourceInjector "
    ...
    private void generatePreamble(Node.Nodes page) throws JasperException {
        ...
        if (pageInfo.isErrorPage()) {
            out.printil(
                    "Throwable exception = org2.apache.jasper.runtime.JspRuntimeLibrary.getThrowable(request);");
        ...
        out.printil("_jspx_resourceInjector = (org2.glassfish.jsp.api.ResourceInjector) application.getAttribute(\"com.sun.appserv.jsp.resource.injector\");");
        out.println();
    }
    ...
    class GenerateVisitor extends Node.Visitor {
         ...
         * @param expectedType the expected type for an EL evaluation (ignored
         * for attributes that aren't EL expressions)
         */
        private String attributeValue(
            ...
            if (attr.isExpression()) {
                if (encode) {
                    return "org2.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf("
                            + v
                ...
                v = JspUtil.interpreterCall(
                        ...
                        null, null, null);
                if (encode) {
                    return "org2.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("
                            + v
                            + ", request.getCharacterEncoding())";
                }
                return v;
        ...
        private void printParams(Node n, String pageParam, boolean literal)
            ...
            class ParamVisitor extends Node.Visitor {
                ...
                public void visit(Node.ParamAction n) throws JasperException {
                    ...
                    out.print(" + ");
                    out.print(
                            "org2.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
            ...
            out.printin(
                    "org2.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "
                    + pageParam);
         ...
         * <param> subelements. For each <param> element, if its value is
         * specified via a Named Attribute (<jsp:attribute>), generate the code
         * to evaluate those bodies first.
         * <p>
        ...
        public void visit(Node.GetProperty n) throws JasperException {
            ...
            if (beanInfo.checkVariable(name)) {
                ...
                out.printil(
                        "out.write(org2.apache.jasper.runtime.JspRuntimeLibrary.toString("
                        + "((("
                        + beanName
                ...
                out.printil(
                        "out.write(org2.apache.jasper.runtime.JspRuntimeLibrary.toString"
                        + "(org2.apache.jasper.runtime.JspRuntimeLibrary.handleGetProperty"
                        + "(_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
        ...
        public void visit(Node.SetProperty n) throws JasperException {
            ...
            if ("*".equals(property)) {
                out.printil(
                        "org2.apache.jasper.runtime.JspRuntimeLibrary.introspect("
                        + "_jspx_page_context.findAttribute("
                        + "\""
                        + name
                        + "\"), request);");
                ...
                out.printil(
                        "org2.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
                ...
                out.printil(
                        "org2.apache.jasper.runtime.JspRuntimeLibrary.handleSetProperty("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
                ...
                out.printil(
                        "org2.apache.jasper.runtime.JspRuntimeLibrary.handleSetPropertyExpression("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
        ...
        public void visit(Node.CustomTag n) throws JasperException {
            ...
            if (ci.isScriptless() && !ci.hasScriptingVars()) {
                ...
                // variable defined.
                out.printil("//ghy visit.custom in" + GHYCount.getCount());
                ...
                out.printil("//存档案" + GHYCount.getCount());
                outSave = out;
                ...
                out.printil("//开始输出函数体" + GHYCount.getCount());
                out.println();
                out.pushIndent();
            ...
            out.printil("//ghy visit.custom 中场休息" + GHYCount.getCount());
            if (n.implementsSimpleTag()) {
                // 不会执行
                generateCustomDoTag(n, handlerInfo, tagHandlerVar);
            } else {
                out.printil("//ghy visit.custom 开始start" + GHYCount.getCount());
                /*
                ...
                // visit body
                out.printil("//ghy visit.custom start 结束" + GHYCount.getCount());
                ...
                out.printil("//ghy visit.custom visit body" + GHYCount.getCount());
                visitBody(n);
                out.printil("//ghy visit.custom visit body 结束" + GHYCount.getCount());
                parent = tmpParent;
                ...
                out.printil("//ghy visit.custom end begin" + GHYCount.getCount());
                generateCustomEnd(
                        n,
                        tagHandlerVar,
                        tagEvalVar,
            ...
            out.printil("//ghy visit.custom end end 。。" + GHYCount.getCount());
            if (ci.isScriptless() && !ci.hasScriptingVars()) {
                ...
                out.printil("//读档案" + GHYCount.getCount());
                out = outSave;
            }
            out.printil("//ghy visit.custom out" + GHYCount.getCount());
        }
        ...
        public void visit(Node.TemplateText n) throws JasperException {
            ...
            if (genBytes || ctxt.getOptions().genStringAsCharArray()) {
                ...
                if (genBytes) {
                    out.printin("((org2.apache.jasper.runtime.JspWriterImpl)out).write(_jspx_same_encoding(response.getCharacterEncoding()), ");
                    out.print(arrayName);
                    out.print(", ");
                    out.print(arrayName);
                    out.println("S);");
        ...
        public void visit(Node.InvokeAction n) throws JasperException {
            ...
            // page
            out.printil(
                    "((org2.apache.jasper.runtime.JspContextWrapper) this.jspContext).syncBeforeInvoke();");
        ...
        private String convertString(
            ...
            if (propEditorClass != null) {
                ...
                return "("
                        + className
                        + ")org2.apache.jasper.runtime.JspRuntimeLibrary.getValueFromBeanInfoPropertyEditor("
                        + className
                        + ".class, \""
                        + attrName
                        + "\", "
                ...
                return "("
                        + className
                        + ")org2.apache.jasper.runtime.JspRuntimeLibrary.getValueFromPropertyEditorManager("
                        + className
                        + ".class, \""
                        + attrName
                        + "\", "
        ...
        private void generateJspFragment(Node n, String tagHandlerVar)
            ...
            // the org2.apache.jasper.runtime package as a support class.
         ...
         * @param tagHandlerVar The variable the tag handler is stored in, so
         * the fragment knows its parent tag.
    ...
    public static void generate(
        ...
        if (gen.ctxt.isTagFile()) {
            ...
            System.out.println("not tag file.........");
    ...
    private void generateTagHandlerPostamble(TagInfo tagInfo) {
        ...
        out.pushIndent();
        out.printil(
                "((org2.apache.jasper.runtime.JspContextWrapper) jspContext).syncEndTagFile();");
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
    ...
    private void generateSetJspContext(TagInfo tagInfo) {
        ...
        if (aliasSeen) {
            out.printil(
                    "this.jspContext = new org2.apache.jasper.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, aliasMap);");
        } else {
            out.printil(
                    "this.jspContext = new org2.apache.jasper.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, null);");
        }
        out.popIndent();
        out.printil("}");
        out.println();
    ...
    private void generatePageScopedVariables(JasperTagInfo tagInfo) {
        ...
        for (int i = 0; i < attrInfos.length; i++) {
            ...
            if (attrInfos[i].isDeferredValue()) {
                ...
                out.printin("org2.apache.jasper.runtime.PageContextImpl.setValueVariable(");
                out.print("_jspx_page_context, ");
                out.print(quote(attrName));
                out.print(", ");
                out.print(toGetterMethod(attrName));
            ...
            if (attrInfos[i].isDeferredMethod()) {
                ...
                out.printin("org2.apache.jasper.runtime.PageContextImpl.setMethodVariable(");
                out.print("_jspx_page_context, ");
                out.print(quote(attrName));
                out.print(", ");
                out.print(toGetterMethod(attrName));
    ...
    private static class FragmentHelperClass {
        ...
        public void generatePreamble() {
            ...
            out.printil(
                    "    extends " + "org2.apache.jasper.runtime.JspFragmentHelper");
            out.printil("{");
            out.pushIndent();
            out.printil(
