...
import org2.apache.jasper.compiler.tagplugin.TagPluginContext;
...
abstract class Node implements TagConstants {
    ...
    public static class TemplateText extends Node {
         ...
         * at the start of this node. The corresponding java line is assumed to
         * be consecutive, i.e. one more than the last.
         */
    ...
    public static class JspAttribute {
         ...
         * (stripped of "<%=", "%>", "%=", or "%" but containing "${" and "}"
         * for EL expressions)
         */
    ...
    public static class Nodes {
        ...
        public void visit(Visitor v) throws JasperException {
            ...
            while (iter.hasNext()) {
                Node n = iter.next();
//                System.out.println(n.getClass().getName() + "class name");
                n.accept(v);
            }
        }
...
//            System.out.println("Node.Visitor visit root");
            doVisit(n);
            visitBody(n);
        }
