...
final class Mark {
     ...
     *
     * @return null if there is no previous stream The previous Makr instance
     * when the stream is pushed.
     */
    ...
    /**
     * @return true if this Mark is greather than the <code>other</code> Mark,
     * false otherwise.
     */
