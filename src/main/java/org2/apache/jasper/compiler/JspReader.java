...
class JspReader {
    ...
    public void showP(String msg) {
        System.out.println(msg + ":" + current.getLineNumber() + "-" + current.getColumnNumber() + "-" + current.cursor
        );
    }
    /*
     * Constructor.
     ...
     *
     * @exception MalformedURLException if the path name is not given in the
     * correct form
     */
     ...
     * inclusion. Each included file gets a uniq identifier (which is the index
     * in the array of source files).
     *
     * @return The index of the now registered file.
     */
