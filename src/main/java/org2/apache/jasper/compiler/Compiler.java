...
import org2.apache.jasper.servlet.JspServletWrapper;
...
public class Compiler {
    ...
    private void generateJava() throws Exception {
        ...
        System.out.println("generateJava 开始编译为java 源文件 begin");
        ...
        try {
            ...
            System.out.println("ctl 编译 begin");
            pageNodes = parserCtl.parse(ctxt.getJspFile());
            System.out.println("ctl 编译 end");
            ...
            Generator.generate(writer, this, pageNodes);
            System.out.println("generateJava 开始编译为java 源文件 end");
            writer.close();
            writer = null;
...
//            }
    ...
    /**
     * Get an instance of JavaCompiler. If a compiler is specified in Options,
     * use that, else if Running with JDK 6, use a Jsr199JavaCompiler that
     * supports JSR199, else if eclipse's JDT compiler is available, use that.
    ...
    /**
     * Return true if the path refers to a jar file in WEB-INF and is a system
     * jar.
     */
